        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BankAccountInfo = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SetByAdminId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CommissionSettings_Admins_SetByAdminId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: false),
                    NationalIdFrontUrl = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                    NationalIdBackUrl = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    ExtractedName = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    ExtractedNationalId = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_IdentityVerifications_Admins_ReviewedByAdminId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Properties_Universities_UniversityId",
                        column: x => x.UniversityId,
                        principalTable: "Universities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CommissionRate = table.Column<decimal>(type: "decimal(5,2)", nullable: false, defaultValue: 10.00m),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChatConversations_Owners_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "Owners",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_ChatConversations_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReportedPropertyId = table.Column<int>(type: "int", nullable: true),
                    ReportedUserId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Report_Target", "[ReportedPropertyId] IS NOT NULL OR [ReportedUserId] IS NOT NULL");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PdfUrl = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    PropertyId = table.Column<int>(type: "int", nullable: false),
                    CleanlinessRating = table.Column<byte>(type: "tinyint", nullable: false),
                    SafetyRating = table.Column<byte>(type: "tinyint", nullable: false),
                    InternetRating = table.Column<byte>(type: "tinyint", nullable: false),
                    LocationRating = table.Column<byte>(type: "tinyint", nullable: false),
                    QuietnessRating = table.Column<byte>(type: "tinyint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Message_Content", "[MessageText] IS NOT NULL OR [ImageUrl] IS NOT NULL");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatConversations_OwnerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatConversations_StudentId_OwnerId_PropertyId",
                table: "ChatConversations",
                columns: new[] { "StudentId", "OwnerId", "PropertyId" },
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommissionSettings_SetByAdminId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Favorites_StudentId_PropertyId",
                table: "Favorites",
                columns: new[] { "StudentId", "PropertyId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Properties_UniversityId",
                table: "Properties",
                column: "UniversityId");

            migrationBuilder.CreateIndex(
                name: "IX_Property_Geo",
                table: "Properties",
